...
const EspecialidadScreen = () => {
  ...
  // Estado de los datos (Convertido a state para poder editar/actualizar)
  ...
  const initialFormState = { id: null, codigo: '', nombre: '' };
  ...
  const handleOpenEdit = (item) => {
    setFormData(item); // Carga los datos de la fila en el formulario
    setIsEditing(true);
    setIsModalOpen(true);
    setOpenMenuIndex(null);
  };
