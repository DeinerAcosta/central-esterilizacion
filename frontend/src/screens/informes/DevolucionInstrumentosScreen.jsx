...
const DevolucionInstrumentosScreen = () => {
  const [isModalOpen, setIsModalOpen] = useState(false); // Modal "Crear Devolución"
  const [isSelectIngresoOpen, setIsSelectIngresoOpen] = useState(false); // Modal "Seleccionar Ingreso"
  ...
  // Helper Input
  const ModalInput = ({ label, placeholder, icon: Icon, required = false, type = "text", width = "w-full" }) => (
