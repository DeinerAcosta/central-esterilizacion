...
const IndicadorBiologicoScreen = () => {
  // --- ESTADOS ---
  ...
  const [isPreviewModalOpen, setIsPreviewModalOpen] = useState(false); // NUEVO: Estado para Vista Previa
  ...
  const ModalInput = ({ label, defaultValue, icon: Icon, className = "w-full" }) => (
    ...
    <div className="space-y-6 h-full flex flex-col font-sans relative" onClick={() => setOpenMenuIndex(null)}>
      ...
      <div className="flex flex-col xl:flex-row gap-4 justify-between items-center bg-white p-1 rounded-xl">
        ...
        <div className="flex items-center gap-4">
            <button onClick={(e) => { e.stopPropagation(); handleDownloadGlobal(); }} className="flex items-center gap-1 text-blue-500 font-medium text-xs hover:text-blue-600 transition-colors px-4">
