...
import { 
  LayoutDashboard, RefreshCw, FileText, ClipboardList, Settings, 
  Bell, ChevronDown, ChevronUp, FileBarChart 
} from 'lucide-react';
      ...
      <header className="bg-gradient-to-r from-blue-500 to-teal-400 text-white shadow-md">
        <div className="px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-6 lg:gap-8">
            <div className="font-bold text-lg tracking-wider uppercase">Central de Esterilización</div>
